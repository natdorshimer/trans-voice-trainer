export declare module 'essentia.js' {
    /**
     * @license
    ...
    export declare class Essentia {
         ...
         * @memberof Essentia
         */
        LPC(frame: any, order?: number, sampleRate?: number, type?: string): { lpc: any, reflection: any };
         ...
         * @memberof Essentia
         */
        PitchYin(signal: any, frameSize?: number, interpolate?: boolean, maxFrequency?: number, minFrequency?: number, sampleRate?: number, tolerance?: number): {
            pitch: number,
